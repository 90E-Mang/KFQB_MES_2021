...
namespace KFQB_Form
{
    public partial class PP_WCTRunStopList_M : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void PP_WCTRunStopList_M_Load(object sender, EventArgs e)
        {
            ...
            rtnDtTemp = GetStopList();
            UltraGridUtil.SetComboUltraGrid(this.grid1, "REMARK", rtnDtTemp, "CODE_ID", "CODE_NAME");
            #endregion
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Modified:
                            #region 수정 
                            helper.ExecuteNoneQuery("PP_WCTRunStopList_M_U1", CommandType.StoredProcedure
        ...
        private DataTable GetStopList()
        {
            ...
            try
            {
                ...
                Sql += "  WHERE USEFLAG = 'Y'";
                return helper.FillTable(Sql, CommandType.Text);
