    ...
    public partial class MM_StockMMREC : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void MM_StockMMREC_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "MATLOTNO",    "LOTNO",          true, GridColDataType_emu.VarChar,     130, 200, Infragistics.Win.HAlign.Left,  true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "INOUTDATE",   "입출고일자",     true, GridColDataType_emu.VarChar,     130, 200, Infragistics.Win.HAlign.Left,  true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "INOUTWORKER", "입출등록자",     true, GridColDataType_emu.VarChar,     130, 200, Infragistics.Win.HAlign.Left,  true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "PONO",        "발주번호",       true, GridColDataType_emu.VarChar,     130, 200, Infragistics.Win.HAlign.Left,  true, true);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                DataTable dtTemp = new DataTable();
                dtTemp = helper.FillTable("15MM_StockMMREC_S1", CommandType.StoredProcedure, 
