...
//   Form Name    : 제품 출고 이력 및 거래 명세서 발행
    ...
    public partial class WM_TradingManager : DC00_WinForm.BaseMDIChildForm
    {
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("00WM_TradingManager_S1", CommandType.StoredProcedure
        ...
        private void grid1_AfterRowActivate(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("00WM_TradingManager_S2", CommandType.StoredProcedure
                                                             , helper.CreateParameter("PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                             , helper.CreateParameter("TRADINGNO", sTradingNo, DbType.String, ParameterDirection.Input)
                                                             );
                if (rtnDtTemp.Rows.Count > 0)
        ...
        private void btnWorker_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("15WM_TradingManager_S3", CommandType.StoredProcedure
                                                             , helper.CreateParameter("PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                             , helper.CreateParameter("TRADINGNO", sTradingNo, DbType.String, ParameterDirection.Input)
                                                             );
                if (rtnDtTemp.Rows.Count > 0)
